      ...
      <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    // SQL query to retrieve data from tblusers
                    $sql = "SELECT userid, email, username FROM tblusers";
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td>
                                    <a href="edit.php?id=' . $row["userid"] . '" class="btn btn-primary btn-sm">Edit</a>
                                    <a href="user.php?delete=' . $row["userid"] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this record?\');">Delete</a>
                                  </td>';
                            echo "</tr>";
                        }
                    } else {
                    ...
                    if (isset($_GET['delete']) && !empty($_GET['delete'])) {
                        ...
                        $delete_sql = "DELETE FROM tblusers WHERE userid = $delete_id";
                ...
                <div class="col-lg-8 col-md-6">
                  <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                    <p class="mb-0">
                      ...
                      Developed by <a class="text-white border-bottom" href="https://htmlcodex.com">applight digital Technologies, PLC</a>
                    </p>
                  </div>
                </div>
              </div>
