            ...
            <table id="dash-table" class="table table-striped table-bordered table-hover" style="font-size:12px" cellspacing="0">
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<tr>";
                        echo "<td>" . $row["id"] . "</td>";
                        echo "<td><img src='photos/" . $row["photo"] . "' width='100' height='100'></td>";
                        ...
                        <a href="edit.php?id=' . $row["id"] . '" class="btn btn-primary btn-sm">
                                ...
                                <a href="?delete=' . $row["id"] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this course?\');">
